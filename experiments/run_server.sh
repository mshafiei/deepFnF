...
cmd1="python deploy --image docker.io/mohammadsh/deepfnf:latest --priority $3 --key kub --name $2 --ngpus $ngpus --cpu $ncpus --meml $meml --memr $memr --type job_deeplearning --cmd"
