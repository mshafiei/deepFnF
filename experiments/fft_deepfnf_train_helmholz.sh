...
name=msh-deepfnf-helmholz-phi1-psi1-fixed-lmbda001
lambda="--expname fft_log_helmholz-phie1-psie1-fixed-lmbda001 --min_lmbda_phi 1. --min_lmbda_psi 1. --fixed_lambda --max_lambda 0.001"
