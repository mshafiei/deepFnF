...
class Net:
    def __init__(self, num_basis=90, ksz=15, burst_length=2, channels_count_factor=1, lmbda=1,IMSZ=448):
        self.weights = {}
    ...
    def forward(self, inp):
        ...
        filtered_screen_poisson_r = tfu.screen_poisson(self.lmbda, denoised[...,0], denoised[...,0]*0, denoised[...,0]*0, self.IMSZ)
        filtered_screen_poisson_g = tfu.screen_poisson(self.lmbda, denoised[...,1], denoised[...,1]*0, denoised[...,1]*0, self.IMSZ)
        filtered_screen_poisson_b = tfu.screen_poisson(self.lmbda, denoised[...,2], denoised[...,2]*0, denoised[...,2]*0, self.IMSZ)
        ...
        return filtered_screen_poisson