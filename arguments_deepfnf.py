...
def parse_arguments_deepfnf():
    ...
    parser.add_argument('--llf_levels', type=int, default=8, help='size of kernel')
    ...
    parser.add_argument('--model', type=str,default='deepfnf',choices=['deepfnf_combine_laplacian_pixelwise', 'deepfnf_llf','deepfnf','deepfnf_fft','unet', 'deepfnf_grad','deepfnf_combine_fft','deepfnf_combine_laplacian','net_flash_image','deepfnf-slim'],help='Neural network model')
    parser.add_argument('--scalemap', type=str_to_bool,default=True,nargs='?', const=True,help='Use scalemap?')
    parser.add_argument('--dataset_model', type=str, default='default', choices=['default','prefetch','prefetch_nthread'], help='Validation dataset')
