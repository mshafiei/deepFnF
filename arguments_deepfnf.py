...
def parse_arguments_deepfnf():
    ...
    parser.add_argument('--per_layer_decoder_nchannels', type=int, default=3, help='Weight dir')
    ...
    parser.add_argument('--llf_remap_function', type=str, default='exp_1d', choices=['exp_1d','manual_1d','exp_2d','gaussian_1d','piecewise_linear','manual'], help='size of kernel')
