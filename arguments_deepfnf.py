...
def parse_arguments_deepfnf():
    ...
    parser.add_argument('--per_layer_decoder_nchannels', type=int, default=1, help='Weight dir')
    parser.add_argument('--visualize_freq_test', type=int, default=10, help='How many iterations before visualization')
    parser.add_argument('--visualize_freq_train', type=int, default=50000, help='How many iterations before visualization')
    ...
    parser.add_argument('--show_insets', type=str_to_bool, default=False, help='size of kernel')
    ...
    parser.add_argument('--has_image_weights', type=str_to_bool, default="False", help='How many iterations before visualization')
    parser.add_argument('--use_halide_implementation', type=str_to_bool, default=False, help='size of kernel')
    parser.add_argument('--apply_gradient', type=str_to_bool, default=True, help='size of kernel')
    parser.add_argument('--llf_remap_function', type=str, default='gaussian_1d', choices=['exp_1d','manual_1d','exp_2d','gaussian_1d','piecewise_linear','manual'], help='size of kernel')
    parser.add_argument('--llf_remap_function_type', type=str, default='None', choices=['no_nn','fixed_top_layer','None'], help='size of kernel')
