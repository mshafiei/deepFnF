...
def parse_arguments_deepfnf():
    ...
    parser.add_argument('--visualize_metrics', type=str_to_bool, default="False", help='How many iterations before visualization')
    ...
    parser.add_argument('--save_freq_rare', type=int,default=500000,help='How often save parameters')
    ...
    parser.add_argument('--alphas', nargs='+', type=float, help='A list of numbers')
    parser.add_argument('--betas', nargs='+', type=float, help='A list of numbers')
    ...
    parser.add_argument('--gllf_scalar', type=str_to_bool,default=True,help='Neural network model')
    parser.add_argument('--yuv_gllf', type=str_to_bool,default=False,help='Neural network model')
    parser.add_argument('--max_iter', type=int, default=1500000, help='size of kernel')
    ...
    parser.add_argument('--num_basis_deepfnf2', type=int,default=90,help='number of basis')
    ...
    parser.add_argument('--double_network', type=str_to_bool,default=True,nargs='?', const=True,help='export images separately or all together')
    ...
    parser.add_argument('--IMSZ', type=int,default=448,help='test_set_count')
    parser.add_argument('--large_images_post_process', type=str_to_bool,default=False,help='test_set_count')
    parser.add_argument('--large_images', type=str_to_bool,default=False,help='test_set_count')
