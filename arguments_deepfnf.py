...
def parse_arguments_deepfnf():
    ...
    parser.add_argument('--model', type=str,default='deepfnf',choices=['net_llf_tf2_tf_local_alpha_Deepfnf_alpha', 'net_llf_tf2_tf_local_alpha_Deepfnf', 'deepfnf_llf_alpha_map_unet_tf','deepfnf_llf_alpha_map_image_tf','deepfnf_refine_unet', 'deepfnf_llf_alpha_map_unet_v2', 'deepfnf_llf_alpha_map_image_v2', 'deepfnf_llf_scalar_alpha','deepfnf_llf_scalar_alpha_encoder','deepfnf_llf_alpha_map_unet', 'deepfnf_llf_alpha_map_image', 'flash','noisy','unet_llf','deepfnf_combine_laplacian_pixelwise', 'deepfnf_llf', 'deepfnf_llf_diffable','deepfnf','deepfnf_fft','unet', 'deepfnf_grad','deepfnf_combine_fft','deepfnf_combine_laplacian','net_flash_image','deepfnf-slim'],help='Neural network model')
